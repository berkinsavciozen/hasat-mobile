...
export function SessionBoundary({ children }: { children: ReactNode }) {
  ...
  // Validation is route-specific: a result from the previous route must never
  // authorize the next route while its own validation is still in flight.
  // Brand bootstrap vs route skeleton remains controlled by the separate latch.
